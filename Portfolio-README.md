...
| Folder | Description |
|---------|--------------|
| 📂 [Test-Cases]([.Tast-Cases)) | Real-world test cases with detailed steps and expected results |
| 📂 [Bug-Reports](./Bug-Reports) | Structured defect reports with severity, priority, and visuals |
| 📂 [Checklists](./Checklists) | Quick QA checklists for functional, UI, and regression testing |
| 📂 [Test-Scenarios](./Test-Scenarios) | End-to-end testing scenarios simulating user flows |
| 📂 [Learning-Path](./Learning-Path) | Notes and materials from QA studies |
| 📂 [Certificates](./Certificates) | QA-related certifications and achievements |
| 📂 [Tools](./Tools) | Examples of tools and screenshots from real testing environments |
